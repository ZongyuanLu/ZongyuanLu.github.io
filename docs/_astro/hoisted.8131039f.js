import{p as r}from"./Footer.astro_astro_type_script_index_0_lang.05e9bb07.js";fetch(`https://api.github.com/users/${r.github_name}/repos?per_page=4`).then(t=>t.json()).then(t=>{o(t)});function o(t){t.sort((e,i)=>i.stargazers_count-e.stargazers_count),t=t.filter(e=>!(e.fork||e.name.trim().toUpperCase()===r.github_name.trim().toUpperCase()));const a=document.getElementById("projects"),s=t.map(e=>`
